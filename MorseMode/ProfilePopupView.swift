...
enum DifficultyLevel: String, CaseIterable, Codable {
    ...
    var speedMultiplier: Double {
        switch self { case .easy: return 0.65; case .normal: return 1.00; case .hard: return 1.50 }
    }
    ...
    var subtitle: String {
        switch self {
        case .easy:   return "Slower · 3 hints"
        case .normal: return "Standard · 1 hint"
        case .hard:   return "Fast · No hints"
        }
    }
    var icon: String {
...
func rankName(for level: Int) -> String {
    ...
    case 3...5:   return "Signal Analyst"
    case 6...9:   return "Cipher Agent"
    case 10...13: return "Shadow Operative"
    ...
    private var statsContent: some View {
        VStack(spacing: 10) {
            ...
            HStack(spacing: 10) {
                ...
                statBadge(icon: "checkmark.seal.fill", value: "\(userProgress.completedLevels.count)/14", label: "JOURNEY")
        ...
        VStack(alignment: .leading, spacing: 10) {
            ...
            HStack(spacing: 8) {
                ForEach(DifficultyLevel.allCases, id: \.self) { diff in
                    ...
                    Button { withAnimation(.easeInOut(duration: 0.15)) { extras.difficulty = diff } } label: {
                        VStack(spacing: 5) {
...
struct ProfileView: View {
        ...
        VStack(spacing: 12) {
            ...
            LazyVGrid(columns: cols, spacing: 10) {
                ...
                StatTile(icon: "checkmark.seal.fill",
                         value: "\(userProgress.completedLevels.count)/14",
                         label: "JOURNEY")
    ...
    private var settingsSection: some View {
        VStack(spacing: 10) {
            ...
            AgentToggleRow(label: "Pause Digital Rain",  icon: "eye.slash",             isOn: $playbackSettings.isDigitalRainPaused)
            AgentToggleRow(label: "Flashlight",          icon: "flashlight.on.fill",    isOn: $flashlightOn)
                .onChange(of: flashlightOn) { _, on in FlashlightManager.set(on) }
